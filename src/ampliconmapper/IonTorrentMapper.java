...
//		pane.setGridLinesVisible(true);
			...
			try {
				while((line = reader.readLine()) != null) {
					...
					if(!line.isEmpty() && matcher.find()){
						logMessage(outputField, "Incompatible character(s) in line:" + line);
						return false;
					}
				}
			}catch(IOException e) {
	...
	private class RunPipeline extends Task<Void>{
		...
		public Void call() {
			...
			logMessage(outputField, "Consolidated Reports");
